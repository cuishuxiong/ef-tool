...
export  class ECPointFp {
    ...
    isInfinity() {
        ...
        return this.z.equals(BigInt(0)) && !this.y.toBigInteger().equals(BigInt(0))
    }
    ...
    add(b) {
        ...
        if (BigInt(0).equals(w3)) {
            if (BigInt(0).equals(w6)) {
